...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-reorder"></i>Create Ad</div>
	</div>
	<div class="portlet-body form">
	<form action="insert_ad1.php" method="post" enctype="multipart/form-data" name="frm" id="frm"  class="form-horizontal form-bordered">
	<div class="form-body">
	...
	<div class="form-group">
		...
		<div class="col-md-6">
			<input  name="custom_url" type="text"  class="form-control" id="custom_url" value="" placeholder="Enter URL">
		</div>
	</div>
	<div class="form-group">
